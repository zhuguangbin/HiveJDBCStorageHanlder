...
public class OracleDBRecordReader extends DBRecordReader<DBWritable> {
  ...
  public OracleDBRecordReader(DBInputSplit split, Class inputClass, Configuration conf,
      Connection conn, DBConfiguration dbConf, String cond, String[] fields, String table)
      throws SQLException {
    super(split, inputClass, conf, conn, dbConf, cond, fields, table);
  ...
  protected String getSelectQuery() {
    ...
    HiveDBInputFormat.DBInputSplit split = getSplit();
